...
# Creating Tabs
tab1, tab2, tab3 = st.tabs(["Home","Dashboard","Geo-Visualization"])
...
with tab1:
    ...
    st.markdown('**:red[Step 4] :**  In the application we provide data visualization option to the user depending upon the data')
